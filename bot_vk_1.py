...
TOKEN = 'vk1.a.psMq_CslP7UkHUuCDtpCjMpqxaVREyN2i8VRTTC9IbKS0USTRQSzhknMXftF56g5Asm_D67j7tEY__IKlq6ZPsW6NzaqXJol_HPZ9lVkHIkv2VrJEvcTxbp6bZIHW8-emz0l8jjWoXBiR6vJbeeNnCUzu7DWsPYJgl2JCik-7GIw8za7xqjZVjGkfXfMtami3Bq6R2krJz8LcvJZSFaa8g'
...
def run_bot_vk_1():
    ...
    try:
        ...
        print(f"Ошибка авторизации (Бот 1). Детали: {e}")
        return
